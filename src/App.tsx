...
> = {
  TR: {
    ...
    brandEyebrow: 'Data Analyst | Engineer',
    welcome: '',
    hero: {
      eyebrow: 'Data Analyst | Engineer · Hoş geldin',
      titleMain: 'Data Analyst | Engineer',
    ...
    projects: [
      ...
      {
        title: 'Employee Management System (Prestij Stajı)',
        description:
        ...
        gallery: [
          ...
          '/projects/Employee Management/Desktop 2026-02-10 2-11-46 AM-255.png',
          '/projects/Employee Management/Desktop 2026-02-10 2-11-48 AM-928.png',
        ],
        details: {
          backend: 'C# .NET Framework 4.7.2, WinForms',
          frontend: 'Windows Forms UI, DataGridView, tema/renk standartlaştırma',
          database: 'SQL Server / LocalDB',
          orm: 'ADO.NET (SqlConnection, SqlCommand, SqlDataReader)',
          auth: 'Kullanıcı giriş/kayıt doğrulama',
          layers: ['Kullanıcı Doğrulama', 'Dashboard İstatistikleri', 'Personel CRUD (Soft Delete)', 'Arama/Filtreleme', 'Maaş Yönetimi', 'UI Tema Yönetimi'],
          versionControl: 'Git, GitHub',
          architecture: 'WinForms masaüstü uygulama, ADO.NET veri erişimi, merkezi tema yönetimi',
        },
      },
      {
        title: 'Label Reading and Matching System (Sanofi Stajı)',
        description:
        ...
        gallery: [
          ...
          '/projects/Label Reading/Desktop 2026-02-09 10-14-53 PM-714.png',
        ],
        details: {
          backend: 'Flask REST API',
          dataProcessing: 'EasyOCR ile metin çıkarma, Base64 görsel çözümleme, OCR çıktı normalizasyonu, Pandas ile CSV okuma/yazma',
          visualization: 'Web arayüzü üzerinden tarama sonuçları ve eşleşme gösterimi',
          layers: ['Görsel Alma (Base64)', 'OCR İşleme (EasyOCR)', 'Metin Normalizasyonu', 'Ürün Kodu Eşleştirme', 'CSV Kayıt', 'REST API Servisi'],
          versionControl: 'Git, GitHub',
          architecture: 'Flask tabanlı monolitik web uygulama; OCR → Normalize → Match → Log pipeline',
        },
      },
      {
    ...
    about: {
      ...
      openTo: ['Data Analyst', 'Data Engineer', 'Python Developer'],
  ...
  DE: {
    ...
    welcome: '',
    hero: {
      eyebrow: 'Data Analyst | Engineer · Willkommen',
      titleMain: 'Data Analyst | Engineer',
      titleAccent: ' | BSc Computer Engineering',
    ...
    projects: [
      ...
      },
      {
        ...
        details: {
          backend: 'C# .NET Framework 4.7.2, WinForms',
          frontend: 'Windows Forms UI, DataGridView, Theme-/Farbstandardisierung',
          database: 'SQL Server / LocalDB',
          orm: 'ADO.NET (SqlConnection, SqlCommand, SqlDataReader)',
          auth: 'Benutzeranmeldung/-registrierung',
          layers: ['Benutzerauthentifizierung', 'Dashboard-Statistiken', 'Mitarbeiter-CRUD (Soft Delete)', 'Suche/Filterung', 'Gehaltsverwaltung', 'UI-Theme-Management'],
          versionControl: 'Git, GitHub',
          architecture: 'WinForms Desktop-Anwendung, ADO.NET Datenzugriff, zentrales Theme-Management',
        },
      },
      {
        title: 'Label Reading and Matching System (Sanofi Praktikum)',
        description:
        ...
        details: {
          backend: 'Flask REST API',
          dataProcessing: 'EasyOCR Texterkennung, Base64-Bilddekodierung, OCR-Ausgabenormalisierung, Pandas CSV-Lesen/Schreiben',
          visualization: 'Scan-Ergebnisse und Match-Anzeige ueber Web-Interface',
  ...
  EN: {
    ...
    welcome: '',
    hero: {
      eyebrow: 'Data Analyst | Engineer · Welcome',
      titleMain: 'Data Analyst | Engineer',
      titleAccent: ' | BSc Computer Engineering',
    ...
    projects: [
      ...
      {
        title: 'Employee Management System (Prestij Internship)',
        description:
        ...
        details: {
          backend: 'C# .NET Framework 4.7.2, WinForms',
          frontend: 'Windows Forms UI, DataGridView, centralized theme/color styling',
          database: 'SQL Server / LocalDB',
          orm: 'ADO.NET (SqlConnection, SqlCommand, SqlDataReader)',
          auth: 'User login/registration authentication',
          layers: ['User Authentication', 'Dashboard Analytics', 'Employee CRUD (Soft Delete)', 'Search/Filtering', 'Salary Management', 'UI Theme Management'],
          versionControl: 'Git, GitHub',
          architecture: 'WinForms desktop application, ADO.NET data access, centralized theme management',
        },
      },
      {
        title: 'Label Reading and Matching System (Sanofi Internship)',
        description:
        ...
        details: {
          backend: 'Flask REST API',
          dataProcessing: 'EasyOCR text extraction, Base64 image decoding, OCR output normalization, Pandas CSV read/write',
          visualization: 'Scan results and match display via web interface',
          layers: ['Image Reception (Base64)', 'OCR Processing (EasyOCR)', 'Text Normalization', 'Product Code Matching', 'CSV Logging', 'REST API Service'],
          versionControl: 'Git, GitHub',
          architecture: 'Flask-based monolithic web application; OCR → Normalize → Match → Log pipeline',
        },
      },
      {
        title: 'Excel VBA Automation Toolkit (Prototype / Demo)',
